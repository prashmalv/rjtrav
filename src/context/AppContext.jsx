...
export const destinations = [
  { id: 1, name: 'Hawa Mahal', city: 'Jaipur', rating: 4.7, reviews: 8247, category: 'Heritage', price: '₹50/200', fee: 50, img: '🏰', imgUrl: imgs.hawaMahal, desc: 'Built in 1799 by Maharaja Sawai Pratap Singh, the iconic five-storey "Palace of Winds" features 953 small windows (jharokhas) decorated with intricate latticework.', badge: '⭐ UNESCO', bestTime: 'Oct–Mar', officialUrl: 'https://www.tourism.rajasthan.gov.in/hawa-mahal.html' },
  { id: 2, name: 'Amber Fort', city: 'Jaipur', rating: 4.8, reviews: 12340, category: 'Heritage', price: '₹100/500', fee: 100, img: '🏯', imgUrl: imgs.amberFort, desc: 'A majestic fort-palace atop a hill, blending Rajput and Mughal architecture. Known for its ornate Sheesh Mahal (Mirror Palace) and stunning panoramic views.', badge: '⭐ UNESCO', bestTime: 'Oct–Mar', officialUrl: 'https://www.tourism.rajasthan.gov.in/amber-palace.html' },
  { id: 3, name: 'Mehrangarh Fort', city: 'Jodhpur', rating: 4.8, reviews: 9870, category: 'Heritage', price: 'Free', fee: 0, img: '🗼', imgUrl: imgs.mehrangarh, desc: 'One of India\'s largest forts, rising 400 feet above Jodhpur. Houses a fine collection of palanquins, howdahs, royal cradles, arms, armour, and paintings.', badge: '⭐ Majestic', bestTime: 'Nov–Feb', officialUrl: 'https://www.tourism.rajasthan.gov.in/mehrangarh-fort.html' },
  { id: 4, name: 'City Palace Udaipur', city: 'Udaipur', rating: 4.9, reviews: 11200, category: 'Heritage', price: '₹250', fee: 250, img: '🏛️', imgUrl: imgs.udaipur, desc: 'A stunning palace complex on the eastern banks of Lake Pichola. The Mewar dynasty\'s grandeur is on full display with Rajput and European architecture.', badge: '⭐ Royal', bestTime: 'Oct–Mar', officialUrl: 'https://www.tourism.rajasthan.gov.in/city-palace-udaipur.html' },
  { id: 5, name: 'Jaisalmer Fort', city: 'Jaisalmer', rating: 4.8, reviews: 7650, category: 'Heritage', price: 'Free', fee: 0, img: '🌟', imgUrl: imgs.jaisalmer, desc: 'The "Golden Fort" rises from the Thar Desert like a mirage. A living fort where people still reside within its golden sandstone walls.', badge: '⭐ UNESCO', bestTime: 'Nov–Feb', officialUrl: 'https://www.tourism.rajasthan.gov.in/jaisalmer-fort.html' },
  { id: 6, name: 'Ranthambore', city: 'Sawai Madhopur', rating: 4.8, reviews: 5430, category: 'Wildlife', price: '₹500+', fee: 500, img: '🐅', imgUrl: imgs.tiger, desc: '62+ tigers roam the rugged terrain of Ranthambore, one of India\'s most famous tiger reserves. Also home to leopards, sloth bears, and crocodiles.', badge: '🐅 Tiger Reserve', bestTime: 'Oct–Jun', officialUrl: 'https://www.tourism.rajasthan.gov.in/ranthambore.html' },
  { id: 7, name: 'Sam Sand Dunes', city: 'Jaisalmer', rating: 4.7, reviews: 8900, category: 'Desert', price: '₹200', fee: 200, img: '🐪', imgUrl: imgs.dunes, desc: 'Experience the vast Thar Desert with golden sand dunes stretching to the horizon. Camel safaris, folk performances, and stunning sunsets await.', badge: '🐪 Desert', bestTime: 'Nov–Feb', officialUrl: 'https://www.tourism.rajasthan.gov.in/sam-sand-dunes.html' },
  { id: 8, name: 'Lake Pichola', city: 'Udaipur', rating: 4.9, reviews: 13400, category: 'Lakes', price: '₹450 boat', fee: 450, img: '⛵', imgUrl: imgs.lakePichola, desc: 'An artificial freshwater lake created in 1362. A boat ride offers stunning views of the City Palace, Lake Palace Hotel, and Jag Mandir island.', badge: '⛵ Scenic', bestTime: 'Oct–Mar', officialUrl: 'https://www.tourism.rajasthan.gov.in/lake-pichola.html' },
]
